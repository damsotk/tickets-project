const en = {
  ...
  discordMessage: {
    ...
    preview: {
      ...
      appTag: 'App',
      today: 'Today at',
      empty: 'Your message will appear here',
    },
    markdown: {
      bold: 'Bold (Ctrl+B)',
  ...
  articles: {
    ...
    editor: {
      ...
      previewPlaceholder: 'Short description for the card',
      authorPlaceholder: 'Author',
      contentPlaceholder: 'Start writing the article...',
      slugLabel: 'Article address',
      infoboxPlaceholder: 'Not specified',
      save: 'Publish',
      saving: 'Publishing...',
      cancel: 'Cancel',
      success: 'Article published',
      linkPrompt: 'Enter link URL (leave empty to remove the link)',
      toolbar: {
        heading1: 'Heading 1',
        heading2: 'Heading 2',
        heading3: 'Heading 3',
      ...
      errors: {
        ...
        previewRequired: 'Enter a short description',
        previewTooLong: 'Short description is too long',
        authorRequired: 'Enter the author',
        authorTooLong: 'Author name is too long',
        slugInvalid: 'Address may contain only latin letters, digits, "_" and "-"',
        slugTooLong: 'Address is too long',
        infoboxInvalid: 'Summary contains unknown fields',
        infoboxValueTooLong: 'One of the summary fields is too long',
        contentRequired: 'Write the article text',
        contentTooLong: 'Article text is too long',
        generic: 'Failed to publish the article',
      },
    },
  },
  profile: {
    ...
    transfer: {
      ...
      recipientPlaceholder: 'Start typing a nickname (min. 3 characters)',
      amountLabel: 'Amount',
      amountPlaceholder: '0',
      submit: 'Transfer',
      ...
      confirm: {
        ...
        amount: 'Amount',
        recipient: 'Recipient',
        warning: 'Transfers cannot be undone. Make sure you picked the right player.',
        cancel: 'Cancel',
        submit: 'Confirm',
        sending: 'Sending...',
      },
      ...
      errors: {
        recipientRequired: 'Select a recipient from the list',
  ...
  crafts: {
    ingredients: {
      ...
      base_kodeks: 'Codex Armor Base',
      diamond: 'Diamond',
      netherite_scrap: 'Netherite Scrap',
      sea_hearth: 'Heart of the Sea',
      enchanted_book: 'Enchanted Book, Unbreaking III',
      echo_fragment: 'Echo Shard',
      ...
      netherite_helmet: 'Codex Helmet',
      netherite_chestplate: 'Codex Chestplate',
      netherite_leggings: 'Codex Leggings',
      netherite_boots: 'Codex Boots',
      bottle_enchanting: "Bottle o' Enchanting",
      glowstone: 'Glowstone',
      gold_ingot: 'Gold Ingot',
      paper: 'Paper',
      flash_scroll: 'Scroll of Flash',
      back_scroll: 'Scroll of Return',
      time_scroll: 'Scroll of Time',
      clock: 'Clock',
      ender_pearl: 'Ender Pearl',
      nautilus_shell: 'Nautilus Shell',
      prismarine_shard: 'Prismarine Shard',
      recovery_compass: 'Recovery Compass',
      koezistratum: 'Coexistratum',
      koezistratum_hrom: 'Coexistratum Chrome',
      wind_charge: 'Wind Charge',
      mystic_scroll: 'Scriptor of Secrets',
      kinetik_book: 'Book of Kinetic Energy',
      unchant_book: 'Book without Enchantments',
    ...
    recipes: {
      regilant: {
        description:
          'An item that removes jump boost and grants speed; in the off-hand, the effect is reversed.',
      },
      flash_scroll: { description: 'A scroll that flashes all nearby players.' },
      back_scroll: {
        description: 'A scroll that instantly returns you to your last death location.',
      },
      mystic_scroll: { description: 'A scroll that lets you talk to players over a distance.' },
      time_scroll: { description: 'A scroll that freezes all nearby players for a few seconds.' },
      koezistratum: { description: 'An item required to craft a linked chest.' },
      kinetik_book: {
        description: "A book that steals another's speed and converts it into your own.",
      },
      koezistratum_hrom: {
        description:
