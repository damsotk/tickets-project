  ...
  modal: {
    whilelistmodal: {
      ...
      modal: {
        ...
        pages: {
          page1: {
            text: 'Нам потрібно задати тобі декілька питань, перш ніж пустити на сервер. Ми хочемо дізнатися про тебе більше, аби адміністрації було простіше працювати з тобою!',
          },
          page2: {
            hint: 'Постарайтеся відповідати коротко і по суті',
            source: {
              label: 'Звідки ви дізналися про проект?',
          ...
          page3: {
            successText: 'Успішно! Ми отримали ваші відповіді, введіть свій нік нижче, будь ласка.',
            minecraftNick: {
              label: 'Ваш нік в Minecraft',
              placeholder: 'Steve',
            },
            discordNick: {
              label: 'Ваш нік в Discord',
              placeholder: 'username#0000',
            },
            discordInfo: {
              text: 'Після цього перейдіть за посиланням в Discord і прочитайте канал',
              channel: '#як-грати',
              textContinue: '. Додадуть вас у вайтліст протягом 24 годин.',
        ...
        buttons: {
          next: 'Далі',
          submit: 'Надіслати заявку в вайтліст!',
        },
      },
    },
  },
