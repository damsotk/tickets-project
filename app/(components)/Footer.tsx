      ...
      <div className={styles.footerContent}>
        <div className={styles.footerSection}>
          <div className={styles.brandContainer}>
            ...
            />
            <h3 className={styles.brandTitle}>{t.title}</h3>
          </div>
          ...
          <div className={styles.socialLinks}>
            ...
            <a
              href="https://github.com/damsotk/tickets-project"
              target="_blank"
              rel="noopener noreferrer"
              className={styles.socialLink}
              aria-label="GitHub"
        ...
        <div className={styles.footerSection}>
          ...
          <ul className={styles.linkList}>
            ...
            <li>
              <Link href={`/${locale}/create-ticket`} className={styles.footerLink}>
                {t.tickets}
              </Link>
            </li>
            <li>
              <a href="mailto:denispiyack@gmail.com" className={styles.footerLink}>
                {t.support}
              </a>
            </li>
          </ul>
        ...
        <div className={styles.footerSection}>
          <h4 className={styles.sectionTitle}>{t.community}</h4>
          <ul className={styles.linkList}>
            <li>
              <a
                href="https://discord.gg/U6muwVtSa"
        ...
        <div className={styles.footerSection}>
          <h4 className={styles.sectionTitle}>{t.legal}</h4>
          <ul className={styles.linkList}>
            <li>
